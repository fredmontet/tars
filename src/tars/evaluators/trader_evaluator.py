...
from ..utils.metrics import total_net_profit, profit_factor, \
    average_trade_net_profit, cumulative_return
...
class TraderEvaluator(AbstractEvaluator):
    ...
    def evaluate(self) -> DataFrame:
        ...
        df['cumulative return'] = df.apply(lambda row: cumulative_return(row['value'], df.iloc[0][0]), axis=1)
